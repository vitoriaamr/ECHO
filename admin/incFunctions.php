	...
	*/
	...
	function get_tables_info($skip_authentication = false) {
		...
		$all_tables = [
			/* ['table_name' => [table props assoc array] */
				'circle_members' => [
					'Caption' => 'Circle members',
					'Description' => 'Table imported using MySQL2AppGini on 2025-11-18',
					'tableIcon' => 'table.gif',
					'group' => $tg[0],
					'homepageShowCount' => 0
				],
	...
	function getTableList($skip_authentication = false, $include_internal_tables = false) {
		...
		$arrTables = [
			...
			'circle_members' => ['Circle members', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'circles' => ['Circles', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'followers' => ['Followers', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'friends' => ['Friends', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'messages' => ['Messages', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'password_resets' => ['Password resets', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'post_comments' => ['Post comments', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'post_likes' => ['Post likes', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'post_saves' => ['Post saves', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'post_shares' => ['Post shares', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'posts' => ['Posts', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
			'users' => ['Users', 'Table imported using MySQL2AppGini on 2025-11-18', 'table.gif', 'None'],
		];
		...
		if($schema === null) {
			...
			$schema = [
				'circle_members' => [
					...
					'added_at' => [
						'appgini' => "TIMESTAMP NOT NULL DEFAULT 'current_timestamp()'",
						'info' => [
							'caption' => 'Added at',
							'description' => '',
						],
				...
				'posts' => [
					...
					'visibility' => [
						'appgini' => "VARCHAR(20) NULL DEFAULT 'public'",
						'info' => [
							'caption' => 'Visibility',
							'description' => '',
						],
				...
				'users' => [
					...
					'handle' => [
						'appgini' => "VARCHAR(30) NOT NULL UNIQUE",
						'info' => [
							'caption' => 'Handle',
							'description' => '',
						],
