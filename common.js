...
function circle_members_validateData(insertMode) {
	...
	const reqFields = [
		...
		['text', 'circle_id', 'Circle id'],
		['text', 'user_id', 'User id'],
		['text', 'added_at', 'Added at'],
	];
...
function circles_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function followers_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
	...
	const reqFields = [
		// [field-type, field-name, field-caption], ...
		['text', 'follower_id', 'Follower id'],
		['text', 'following_id', 'Following id'],
		['text', 'created_at', 'Created at'],
	];
...
function friends_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
	...
	const reqFields = [
		// [field-type, field-name, field-caption], ...
		['text', 'user1_id', 'User1 id'],
		['text', 'user2_id', 'User2 id'],
		['text', 'created_at', 'Created at'],
	];
...
function messages_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function password_resets_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
	...
	const reqFields = [
		// [field-type, field-name, field-caption], ...
		['text', 'user_id', 'User id'],
		['text', 'new_password_hash', 'New password hash'],
		['text', 'requested_at', 'Requested at'],
	];
...
function post_comments_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function post_likes_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function post_saves_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function post_shares_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function posts_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function users_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
